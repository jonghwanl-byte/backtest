...
class StrategyConfig:
    ...
    ma_windows: Tuple[int, ...] = (20, 60, 120, 200)
    # ON 개수 -> 목표비중 투입 스케일
...
# SCALAR_RULES 딕셔너리를 5단계로 교체
SCALAR_RULES = {
    "4MA_100/75/50/25/0": {4: 1.00, 3: 0.75, 2: 0.50, 1: 0.25, 0: 0.00},
    "4MA_100/85/70/40/0": {4: 1.00, 3: 0.85, 2: 0.70, 1: 0.40, 0: 0.00},
    "4MA_과반":            {4: 1.00, 3: 1.00, 2: 0.50, 1: 0.00, 0: 0.00},
}
